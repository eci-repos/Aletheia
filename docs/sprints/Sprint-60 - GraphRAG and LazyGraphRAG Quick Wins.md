...
Promotes backlog items 1, 4, 5, 6 from `docs/backlog/archive/GraphRAG-LazyGraphRAG-Enhancements.md` (items 2 and 3 stay parked for a later focused sprint).
