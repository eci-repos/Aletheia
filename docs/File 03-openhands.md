...
- Active sprint: `docs/sprints/Sprint-64 - Theme-Aware Graph Retrieval.md` (created 2026-08-11). Sprint 63 complete/committed/pushed (`df7627d`). Promotes Canonical backlog item 5 (the last item in `docs/backlog/Canonical-Form-Themes-Filtering-Enhancements.md`).
